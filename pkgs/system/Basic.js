  ...
  export default {
    ...
    start: async function (Root) {
          ...
          case "normal":
            recoveryOptionsListing.clear().appendMany(
              makeRecoveryCardButton(
                ...
                async () => {
                  await fadeOut();
                  Root.Core.Packages.Run("ui:Desktop", true, true);
                },
              ...
              makeRecoveryCardButton(
                ...
                () => Root.Core.Packages.Run("apps:FileManager", true, true),
          ...
          case "advanced":
            recoveryOptionsListing.clear().appendMany(
              ...
              makeRecoveryCardButton(
                ...
                () => Root.Core.Packages.Run("apps:TaskManager", true, true),
              ...
              makeRecoveryCardButton(
                "Terminal",
                "Launch the Terminal.",
                () => Root.Core.Packages.Run("apps:Terminal", true, true),
              ...
              makeRecoveryCardButton(
                "NoUI",
                "Launch the NoUI interface.",
                async () => {
                    const result = await Modal.prompt(
                        "This will keep you in the NoUI interface. Are you sure you want to do this?"
                      );
                      ...
                      settingsConfig.NoUI = true;

                        await Vfs.writeFile("Root/Pluto/config/settingsConfig.json", JSON.stringify(settingsConfig));
                        await fadeOut();
                        location.reload();
                },
                `<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.99951 25.5078L14.9995 16.5078L5.99951 7.50781" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M18 28.4922H30" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
              ...
              makeRecoveryCardButton(
                ...
                async () => {
                  ...
                  const result2 = await Modal.prompt(
      ...
      const recoveryWindow = new Html("div")
        ...
        .style({ position: "unset" , border: "1px solid var(--outline)", "border-radius": "12px" })
        .append(
          new Html("div")
            ...
            .appendMany(
              ...
              new Html("a")
                ...
                .on("click", () => {
                  Root.Core.Packages.Run("apps:PanicViewer", true, true);
                }),
              new Html("hr"),
