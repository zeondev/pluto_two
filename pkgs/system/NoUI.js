...
export default {
  ...
  start: async (Root) => {
    ...
    wrapper = new Html("div").class("no-ui-wrapper").appendTo("body");

    wrapper.style({ background: "var(--unfocused)" , "height": "100%" , "width": "100%" , overflow: "auto" });
    ...
    document.addEventListener("terminal.append", (e) => {
      appendOutput(e.data);
    });
  },
  end: async function () {
